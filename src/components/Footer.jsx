...
export const Footer = () => {
  ...
  return (
    <Box
      sx={{ bgcolor: "primary.main", color: "white", pt: 15, pb: 10 }}
      id="contact"
    >
      <Container maxWidth="100%">
        <Grid container spacing={10}>
          <Grid item xs={12} md={6}>
            <Typography
              variant="h1"
              sx={{ fontSize: { xs: "4rem", md: "8rem" }, mb: 4 }}
            >
              SAY <br />{" "}
            ...
            <Typography
              variant="h6"
              sx={{ mb: 6, opacity: 0.6, maxWidth: 400 }}
            >
              Looking to build high-performance React applications? Let's
              connect and discuss your vision.
            </Typography>
            <Box sx={{ display: "flex", flexDirection: "column", gap: 3 }}>
              <Typography variant="h5" sx={{ textTransform: "lowercase" }}>
                thungaprathap87@gmail.com
              </Typography>
          ...
          <Grid item xs={12} md={6}>
            <Box sx={{ display: "flex", flexDirection: "column", gap: 4 }}>
              <Box
                sx={{ borderBottom: "2px solid rgba(255,255,255,0.1)", pb: 1 }}
              >
                <Typography
                  variant="caption"
                  color="secondary"
